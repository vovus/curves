...
{
    using YieldCurveSrv;
    public partial class DataFeed : UserControl
	{
		...
		private void listBox1_SelectionChanged(object sender, SelectionChangedEventArgs e)
		{
			...
			if (instrumentId != 0)
				foreach (EntryPointHistory yceh in CachedData.CachedEntryPointHistoryList)
				{
					...
					{
						this.dataGrid1.ItemsSource = yceh.epValueHistory;
						return;
					}
				}
		}
		...
		private void button2_Click(object sender, RoutedEventArgs e)
		{
			...
			if (oFile.ShowDialog() == true)
			{
				...
				ObservableCollection<HistoricValue> yceh = new ObservableCollection<HistoricValue>();
				...
				if (instr.Id != 0)
					foreach (EntryPointHistory i in CachedData.CachedEntryPointHistoryList)
					{
						if (i.Instrument.Id == instr.Id)
						{
							i.epValueHistory = yceh;
							//i.EntryDataHistory.Sort();

							// new data into datagrid
							this.dataGrid1.ItemsSource = i.epValueHistory;
							return;
						}
					}
			}
