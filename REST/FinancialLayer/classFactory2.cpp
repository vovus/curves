...
std::map<std::string, void* > ObjectFactory2::sFactoryMap;
...
void ObjectFactory2::InitObjectFactory()
{
	// clean 1st
	/*
	std::map<std::string, boost::shared_ptr<void>>::iterator factoryPos = ObjectFactory2::sFactoryMap.begin();
	while (factoryPos != ObjectFactory2::sFactoryMap.end())
	{
		delete factoryPos->second;
	}*/
	ObjectFactory2::sFactoryMap.clear();
	...
	RegisterClass<QuantLib::UnitedKingdom, QuantLib::UnitedKingdom::Market>(QuantLib::UnitedKingdom::Settlement);
//}
...
//{
	...
	RegisterClass<QuantLib::ActualActual, QuantLib::ActualActual::Convention>(QuantLib::ActualActual::ISDA);
...
//ObjectFactory<QuantLib::InterestRateIndex>::ClassNameFactoryMap ObjectFactory<QuantLib::InterestRateIndex>::factoryMap;
//void ObjectFactory<QuantLib::InterestRateIndex>::InitObjectFactory()
//{
